...
export default function WorkEthicHorizontalSticky() {
  ...
  return (
    <section
      id="workethics"
      ref={sectionRef}
      className="bg-[#f4f4f4] text-black pb-40"
    >
              ...
              {slides.map((s, i) => (
                <div key={i} className="w-screen h-full px-10">
                  <div className="max-w-[1400px] mx-auto h-full flex items-center">
                    <div className="w-full bg-white rounded-[34px] shadow-[0_30px_80px_rgba(0,0,0,0.08)] border border-black/[0.05] p-6 md:p-8 lg:p-10">
                      <div className="w-full grid grid-cols-1 lg:grid-cols-[680px_1fr] gap-16 items-center">
                        ...
                        <div className="relative -translate-y-2">
                          <div className="">
                            <img
                              src={s.img}
                              alt={s.title}
                              className="block w-full aspect-[12/8] object-contain"
                            />
                          </div>
                        </div>
                        ...
                        <div className="relative max-w-[560px]">
                          ...
                          <div className="relative z-10">
                            ...
                            <h3 className="mt-4 text-[28px] md:text-[40px] font-medium leading-[1.1]">
                              {s.title}
                            </h3>
                            ...
                            <button className="mt-10 px-10 h-[46px] rounded-xl border border-black/30 bg-white hover:border-black/60 hover:shadow-[0_10px_24px_rgba(0,0,0,0.06)] transition">
                              Case Studies
                            </button>
                          </div>
                        </div>
